...
#define UILOCK_REQUEST    0x41000000
#define UILOCK_NONE       0x0000
#define UILOCK_EVERYTHING_EXCEPT_POWEROFF_AND_MODEDIAL 0x014f
#define UILOCK_EVERYTHING 0x017f
#define UILOCK_SHUTTER    0x0001
#define UILOCK_ARROWS     0x0008
#define UILOCK_MODE_DIAL  0x0010
#define UILOCK_POWER_SW   0x0020
...
#else
#define PROP_PICTURE_STYLE 0x80000028  // Canon calls it PROP_FLAVOR_MODE. See enum in picstyle.h
#endif


#if defined(CONFIG_DIGIC_VIII) || defined (CONFIG_DIGIC_X)

// Those hold picture style settings
// Prop size 0x20
#define PROP_PICSTYLE_SETTINGS_STANDARD   0x80000066
#define PROP_PICSTYLE_SETTINGS_PORTRAIT   0x80000067
#define PROP_PICSTYLE_SETTINGS_LANDSCAPE  0x80000068
#define PROP_PICSTYLE_SETTINGS_NEUTRAL    0x80000069
#define PROP_PICSTYLE_SETTINGS_FAITHFUL   0x8000006a
#define PROP_PICSTYLE_SETTINGS_MONOCHROME 0x8000006b
#define PROP_PICSTYLE_SETTINGS_USERDEF1   0x8000006e
#define PROP_PICSTYLE_SETTINGS_USERDEF2   0x8000006f
#define PROP_PICSTYLE_SETTINGS_USERDEF3   0x80000070
#define PROP_PICSTYLE_SETTINGS_AUTO       0x8000006C
#define PROP_PICSTYLE_SETTINGS_FINEDETAIL 0x8000006D

// and those select a "base" picstyle for userdef1-3
#define PROP_PICSTYLE_OF_USERDEF1         0x80000071
#define PROP_PICSTYLE_OF_USERDEF2         0x80000072
#define PROP_PICSTYLE_OF_USERDEF3         0x80000073

#elif defined(CONFIG_DIGIC_45) || defined(CONFIG_DIGIC_VI) || (defined CONFIG_DIGIC_VII)

// Those hold picture style settings
// Prop size 0x18
#define PROP_PICSTYLE_SETTINGS_STANDARD   0x02060001
...
#define PROP_PICSTYLE_SETTINGS_AUTO       0x0206001e // newer cams have this extra one
#if defined(CONFIG_DIGIC_VI) || (defined CONFIG_DIGIC_VII)
#define PROP_PICSTYLE_SETTINGS_FINEDETAIL 0x02060026
# endif
...
#elif !defined(MODULE)
#error No PROP_PICSTYLE scheme defined for your DIGIC generation!
#endif

// IDs for those did not change on D8
...
#define PROP_LIMITED_TV_VALUE_AT_AUTOISO 0x80040034
