 ...
 **/
 ...
 #if defined(CONFIG_M6II) || defined(CONFIG_90D) // M6II and 90D share the same 32.5MP sensor
    // 	{ LIBRAW_CAMERAMAKER_Canon, "EOS M6 Mark II / EOS 90D", 0, 0,
 ...
 *  For now I just copied R
 */
 #if defined(CONFIG_M6II) || defined(CONFIG_90D)
static int dynamic_ranges[] = {1255, 1237, 1188, 1120, 1045, 964, 883, 785, 685, 599};
 #endif
