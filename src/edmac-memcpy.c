...
#elif defined(CONFIG_6D) || defined(CONFIG_5D3) || defined(CONFIG_70D)
uint32_t edmac_read_chan = 0x19;  /* Read: 0 5 7 11 14 15 (70D: 8 25 29 42 43) */
uint32_t edmac_write_chan = 0x11; /* Write: 6 8 15 (70D: 6 17 33) */
